...
const SLIDES: ReelSlide[] = [
  { src: "/assets/editorial/panels/panel-indonesia.png", label: "Indonesia", region: "Southeast Asia", score: 77 },
  { src: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800&q=80&auto=format&fit=crop", label: "Thailand", region: "Southeast Asia", score: 81 },
  { src: "/assets/destinations/turkey.jpg",       label: "Turkey",      region: "Eurasia",        score: 74 },
  { src: "https://images.unsplash.com/photo-1513407030348-c983a97b98d8?w=800&q=80&auto=format&fit=crop", label: "Japan", region: "East Asia", score: 88 },
  { src: "/assets/destinations/philippines.jpg",  label: "Philippines", region: "Southeast Asia", score: 72 },
  { src: "https://images.unsplash.com/photo-1557750255-c76072a7aad1?w=800&q=80&auto=format&fit=crop", label: "Vietnam", region: "Southeast Asia", score: 79 },
  { src: "/assets/destinations/georgia.jpg",      label: "Georgia",     region: "Caucasus",       score: 78 },
  { src: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=800&q=80&auto=format&fit=crop", label: "Malaysia", region: "Southeast Asia", score: 75 },
  { src: "https://images.unsplash.com/photo-1517154421773-0529f29ea451?w=800&q=80&auto=format&fit=crop", label: "South Korea", region: "East Asia", score: 83 },
];
    ...
    <div className="hero-editorial-panel">
      <div className="hero-editorial-frame" style={{ position: "relative" }}>
        ...
        <div
          ...
          style={{ opacity: show ? 1 : 0, transition: `opacity ${FADE_MS * 0.6}ms ease` }}
        >
